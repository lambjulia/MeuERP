    ...
    <ActionSection>
        ...
        <template #content>
            ...
            <div class="mt-3 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                <p>
                    Quando a autenticação de dois fatores estiver habilitada, você será solicitado a fornecer um token seguro e aleatório durante a autenticação. Você pode recuperar esse token pelo aplicativo Google Authenticator do seu celular.
                </p>
            </div>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                        <p v-if="confirming" class="font-semibold">
                            Para concluir a habilitação da autenticação de dois fatores, escaneie o QR code abaixo com o aplicativo autenticador do seu celular ou insira a chave de configuração e forneça o código OTP gerado.
                        </p>
                        <p v-else>
                            A autenticação de dois fatores está habilitada. Escaneie o QR code abaixo com o aplicativo autenticador do seu celular ou insira a chave de configuração.
                        </p>
                    </div>
                ...
                <div v-if="recoveryCodes.length > 0 && !confirming">
                    <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                        <p class="font-semibold">
                            Armazene esses códigos de recuperação em um gerenciador de senhas seguro. Eles podem ser usados para recuperar o acesso à sua conta caso você perca o dispositivo de autenticação.
                        </p>
                    </div>
