    ...
    <ActionSection>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
                Se necessário, você pode encerrar todas as suas outras sessões em todos os seus dispositivos. Algumas sessões recentes estão listadas abaixo; no entanto, esta lista pode não ser completa. Se você acredita que sua conta foi comprometida, atualize também sua senha.
            </div>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Digite sua senha para confirmar que deseja encerrar suas outras sessões em todos os dispositivos.
