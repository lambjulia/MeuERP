    ...
    <div>
        ...
        <FormSection @submitted="createApiToken">
            ...
            <template #description>
                Os tokens de API permitem que serviços de terceiros se autentiquem com nosso aplicativo em seu nome.
            </template>
        ...
        <div v-if="tokens.length > 0">
            ...
            <div class="mt-10 sm:mt-0">
                <ActionSection>
                    ...
                    <template #description>
                        Você pode excluir qualquer um dos seus tokens existentes caso não sejam mais necessários.
                    </template>
        ...
        <DialogModal :show="displayingToken" @close="displayingToken = false">
            ...
            <template #content>
                <div>
                    Por favor, copie seu novo token de API. Por segurança, ele não será exibido novamente.
                </div>
